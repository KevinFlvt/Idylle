    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route path='/prestylles' element = {<Prestylle />} />
            <Route path='/prestylles/toumblak' element = {<Toumblak />} />
            <Route path='/prestylles/kaladja' element = {<Kaladja />} />
            <Route path='/prestylles/mennde' element = {<Mennde />} />
