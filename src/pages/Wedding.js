...
const Wedding = () => {
    ...
    return (
        <div className='wedding'>
            ...
            <p>En tant que wedding planner, nous vous apportons les meilleurs conseils pour organiser les préparatifs de votre mariage et vous offrir la journée de mariage de vos rêves. Notre savoir-faire professionnel et notre passion de l'unviers du mariage sont au service de tous les futurs mariés.</p>
