        ...
        <div className='histoire'>
            <div className="row">
                ...
                <div className="col">
                    ...
                    <p>Je me présente, Talita FRANCIUS, organisatrice d'évènements en tant qu'event planner et baloons designer, fondadtrice de l'agence événementielle « L'idylle event ».</p>
                    <br />
