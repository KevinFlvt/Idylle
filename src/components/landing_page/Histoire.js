...
import photoPresentation from '../../medias/Photo_accueuil.jpeg';
        ...
        <div className='histoire'>
            <div className="row">
                ...
                <div className="col">
                    ...
                    <br />
                    <p>Des événements privés aux évènements professionnels, du dîner romantique, au pique-nique entre amis, l'agence est présente pour répondre à vos besoins et créer votre idylle.</p>
                    <br />
